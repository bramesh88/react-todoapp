...
class TodoListComponent extends Component {
  ...
  retrieveToDoList() {
    let userName = AuthenticationService.getLoggedInUserName();
    ToDoService.retrieveAllToDos(userName).then((response) => {
    ...
    .catch((error) => {
      console.log(error);
      let errorMessage=error.message+". Please check the server availability"
                ...
                <tr key={todo.id}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => this.updateToDoItem(todo.id)}
                    >
                      Update
                    </button>
                  </td>
